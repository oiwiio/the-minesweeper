// ============================================================
// 02-board-setup.js — Вспомогательные функции (счётчик мин, таймер) + создание поля и расстановка мин
// Часть 2/8 игры «Сапёр». Подключать <script> тегами строго в этом порядке (см. README-split.md).
// ============================================================
