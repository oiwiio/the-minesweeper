// ============================================================
// 01-state.js — Настройки, состояние игры, DOM-ссылки, константы (хаос, щит, флаг-метка, звук, способности, миникарта, карт-режим, тема)
// Часть 1/8 игры «Сапёр». Подключать <script> тегами строго в этом порядке (см. README-split.md).
// ============================================================
