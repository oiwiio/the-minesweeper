// ============================================================
// 06-abilities.js — Способности: радар, особый флажок, шестое чувство, эхолот + расчёт размера клеток
// Часть 6/8 игры «Сапёр». Подключать <script> тегами строго в этом порядке (см. README-split.md).
// ============================================================
