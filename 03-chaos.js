// ============================================================
// 03-chaos.js — Вся логика хаос-режима: очки, комбо, события смены поля, щит, флаг-метка, спецэффекты хаоса
// Часть 3/8 игры «Сапёр». Подключать <script> тегами строго в этом порядке (см. README-split.md).
// ============================================================
